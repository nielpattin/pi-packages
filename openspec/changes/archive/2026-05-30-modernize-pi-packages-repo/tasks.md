...
- [x] 1.4 Update TypeScript, Vitest, oxlint, oxfmt, validation, publish, release, and GitHub workflow paths for the new layout.
- [x] 1.5 Refresh pnpm lockfile if workspace changes require it.

## 2. Quality Gates

- [x] 2.1 Add Node 24 CI using pnpm/action-setup v4, Node 24, pnpm cache, frozen lockfile install, check, test, and coverage.
...
- [x] 4.1 Update README narrative, badges, package map, project tree, Node 24 note, hooks, and validation/release/publish docs.
