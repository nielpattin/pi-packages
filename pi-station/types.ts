...
// Separator styles
export type StatusLineSeparatorStyle = "thin";
...
export interface PresetDef {
   ...
   /** Right-aligned segments on the secondary row */
   secondaryRightSegments?: BuiltinStatusLineSegmentId[];
   /** Tertiary row segments */
   tertiarySegments?: BuiltinStatusLineSegmentId[];
