...
export interface LayoutCache {
   ...
   lastLayoutResult: { topContent: string; secondaryContent: string; tertiaryContent: string } | null;
...
export class StationBarState {
   ...
   // Layout cache
   lastLayoutWidth = 0;
   lastLayoutResult: { topContent: string; secondaryContent: string; tertiaryContent: string } | null = null;
