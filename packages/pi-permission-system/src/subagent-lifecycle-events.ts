/**
 * subagent-lifecycle-events.ts — Subscribe to @nielpattin/pi-subagents' child
 * lifecycle events and keep the SubagentSessionRegistry in sync.
 *
 * @nielpattin/pi-subagents publishes its child-execution lifecycle on the Pi
 ...
 * publisher in `@nielpattin/pi-subagents` (`src/lifecycle/child-lifecycle.ts`).
 *
