...
export function safeDeleteFile(logger: ForwardedPermissionLogger | null, filePath: string, description: string): void {
   try {
      unlinkSync(filePath);
   } catch (error) {
...
export function writeJsonFileAtomic(logger: ForwardedPermissionLogger | null, filePath: string, value: unknown): void {
...
export function listRequestFiles(logger: ForwardedPermissionLogger | null, requestsDir: string): string[] {
   try {
