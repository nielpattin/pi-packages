...
import { executePartialRecompInternal, type PartialRecompRange } from "./compartment-runner-partial-recomp";
...
export interface ActiveCompartmentRun {
    ...
    * message every pass and drive Host's runLoop break condition false.
    */
...
function startLeaseRenewal(deps: CompartmentRunnerDeps, holderId: string): ReturnType<typeof setInterval> {
   return setInterval(() => {
