 ...
 *   2. Host's models.dev cache (overlaid with user's
...
type ExecuteThresholdTokensConfig = { default?: number; [modelKey: string]: number | undefined } | undefined;
 ...
 *
 * Host's `experimental.modes` feature derives model IDs like
...
export function resolveModelKey(providerID: string | undefined, modelID: string | undefined): string | undefined {
...
export function resolveSessionId(properties: { info?: unknown; sessionID?: string } | undefined): string | undefined {
