...
function createScopedAssignments(assignments: ReadonlyMap<string, number>): Map<string, ScopedAssignments> {
...
export function createExistingTagResolver(sessionId: string, tagger: Tagger, db: ContextDatabase): ExistingTagResolver {
