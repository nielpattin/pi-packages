...
export function isConfigLoadUntrusted(detailed: EmbeddingLoadResultDetailed<{ embedding: EmbeddingConfig }>): boolean {
   if (
...
export function describeFailure(detailed: EmbeddingLoadResultDetailed<{ embedding: EmbeddingConfig }>): string {
   const parts: string[] = [];
