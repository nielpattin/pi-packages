...
// Audit note: `as TData` casts are intentional at this boundary. The Host plugin SDK types
// external responses as `unknown`. Adding Zod validation here would require schema definitions
// for every SDK response shape, which changes with each Host release. The fallback parameter
