...
**Codebase tools** (standard Host tools):
...
- Present tense: "Historian uses raw Host message ordinals" not "We switched historian to raw ordinals."
...
- Memory: "Durable state lives in ~/.local/share/host/storage/plugin/magic-context/context.db" → check storage-db.ts for the path construction
