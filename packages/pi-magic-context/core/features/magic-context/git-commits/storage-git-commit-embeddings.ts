...
export function saveCommitEmbedding(db: Database, sha: string, embedding: Float32Array, modelId: string): void {
...
export function loadProjectCommitEmbeddings(db: Database, projectPath: string): Map<string, Float32Array> {
...
export function getDistinctCommitEmbeddingModelIds(db: Database, projectPath: string): Set<string | null> {
