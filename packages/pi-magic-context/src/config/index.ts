...
import { substituteConfigVariables } from "#core/config/variable";
...
function mergeRawConfigs(base: Record<string, unknown>, override: Record<string, unknown>): Record<string, unknown> {
