   ...
   pi.registerCommand("ctx-recomp", {
      ...
      handler: async (args, ctx) => {
         ...
         try {
            ...
            // Mirrors Host `hook.ts:477-480`: recomp publishes
...
function queueAndApplyPiRecompMarker(args: { db: ContextDatabase; sessionId: string; ctx: unknown }): void {
...
function readBody(input: unknown): { noReply?: boolean; parts?: unknown } {
   ...
   return typeof body === "object" && body !== null ? (body as { noReply?: boolean; parts?: unknown }) : {};
}
