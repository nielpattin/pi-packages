...
export class ConversationViewer implements Component {
   ...
   constructor({ tui, session, record, activity, theme, done, registry, wrapText }: ConversationViewerOptions) {
      this.tui = tui;
   ...
   private buildContentLines(width: number): string[] {
      ...
      if (this.record.status === "running" && this.activity) {
         lines.push(...formatStreamingIndicator(this.activity.activeTools, this.activity.responseText, width, th));
      }
